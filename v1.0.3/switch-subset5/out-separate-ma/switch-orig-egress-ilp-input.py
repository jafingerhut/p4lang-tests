dM = 9
dA = 1
# dS is for a 'successor' or 'reverse_read' dependency, where the only
# requirement is that the 'to' node must be scheduled no earlier than
# the 'from' node.
dS = 0

# Nodes with type 'condition' are there primarily because of their
# dependencies.  In ILP we should probably, at least for now, treat
# them as actions with 0 num_fields, meaning we can schedule as many
# of them at the same time with other actions as we wish.

# With only dependency constraints taken into account, I get a
# schedule 83 cycles long (earliest events scheduled in clock cycle 0,
# latest in clock cycle 82).
...
{'_condition_55': {'num_fields': 0, 'type': 'condition'},
 ...
 'egress_bd_map_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_bd_map_MATCH': {'key_width': 16, 'type': 'match'},
 'egress_bd_stats_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_bd_stats_MATCH': {'key_width': 19, 'type': 'match'},
 'egress_filter_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_filter_drop_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_ip_acl_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_ip_acl_MATCH': {'key_width': 120, 'type': 'match'},
 'egress_ipv6_acl_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_ipv6_acl_MATCH': {'key_width': 312, 'type': 'match'},
 'egress_l4_dst_port_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_l4_dst_port_MATCH': {'key_width': 16, 'type': 'match'},
 'egress_l4_src_port_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_l4_src_port_MATCH': {'key_width': 16, 'type': 'match'},
 'egress_l4port_fields_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_l4port_fields_MATCH': {'key_width': 3, 'type': 'match'},
 'egress_mac_acl_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_mac_acl_MATCH': {'key_width': 144, 'type': 'match'},
 'egress_nat_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_nat_MATCH': {'key_width': 14, 'type': 'match'},
 'egress_port_mapping_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_port_mapping_MATCH': {'key_width': 9, 'type': 'match'},
 'egress_qos_map_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_qos_map_MATCH': {'key_width': 13, 'type': 'match'},
 'egress_system_acl_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_system_acl_MATCH': {'key_width': 43, 'type': 'match'},
 'egress_vlan_xlate_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_vlan_xlate_MATCH': {'key_width': 32, 'type': 'match'},
 'egress_vni_ACTION': {'num_fields': 8, 'type': 'action'},
 'egress_vni_MATCH': {'key_width': 21, 'type': 'match'},
 'int_bos_ACTION': {'num_fields': 8, 'type': 'action'},
 'int_bos_MATCH': {'key_width': 24, 'type': 'match'},
 'int_insert_ACTION': {'num_fields': 8, 'type': 'action'},
 'int_insert_MATCH': {'key_width': 3, 'type': 'match'},
 'int_inst_0003_ACTION': {'num_fields': 8, 'type': 'action'},
 ...
 'int_inst_0811_ACTION': {'num_fields': 8, 'type': 'action'},
 'int_inst_0811_MATCH': {'key_width': 4, 'type': 'match'},
 'int_inst_1215_ACTION': {'num_fields': 8, 'type': 'action'},
 'int_inst_1215_MATCH': {'key_width': 4, 'type': 'match'},
 'int_meta_header_update_ACTION': {'num_fields': 8, 'type': 'action'},
 'int_meta_header_update_MATCH': {'key_width': 8, 'type': 'match'},
 'int_outer_encap_ACTION': {'num_fields': 8, 'type': 'action'},
 'int_outer_encap_MATCH': {'key_width': 8, 'type': 'match'},
 'l3_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'l3_rewrite_MATCH': {'key_width': 15, 'type': 'match'},
 'mirror_ACTION': {'num_fields': 8, 'type': 'action'},
 'mirror_MATCH': {'key_width': 16, 'type': 'match'},
 'mtu_ACTION': {'num_fields': 8, 'type': 'action'},
 'mtu_MATCH': {'key_width': 10, 'type': 'match'},
 'replica_type_ACTION': {'num_fields': 8, 'type': 'action'},
 'replica_type_MATCH': {'key_width': 17, 'type': 'match'},
 'rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'rewrite_MATCH': {'key_width': 16, 'type': 'match'},
 'rewrite_multicast_ACTION': {'num_fields': 8, 'type': 'action'},
 'rewrite_multicast_MATCH': {'key_width': 14, 'type': 'match'},
 'rid_ACTION': {'num_fields': 8, 'type': 'action'},
 'rid_MATCH': {'key_width': 16, 'type': 'match'},
 'smac_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'smac_rewrite_MATCH': {'key_width': 9, 'type': 'match'},
 'tunnel_decap_process_inner_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_decap_process_inner_MATCH': {'key_width': 3, 'type': 'match'},
 'tunnel_decap_process_outer_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_decap_process_outer_MATCH': {'key_width': 7, 'type': 'match'},
 'tunnel_dmac_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_dmac_rewrite_MATCH': {'key_width': 14, 'type': 'match'},
 'tunnel_dst_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_dst_rewrite_MATCH': {'key_width': 14, 'type': 'match'},
 'tunnel_encap_process_inner_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_encap_process_inner_MATCH': {'key_width': 5, 'type': 'match'},
 'tunnel_encap_process_outer_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_encap_process_outer_MATCH': {'key_width': 10, 'type': 'match'},
 'tunnel_mtu_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_mtu_MATCH': {'key_width': 14, 'type': 'match'},
 'tunnel_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_rewrite_MATCH': {'key_width': 14, 'type': 'match'},
 'tunnel_smac_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_smac_rewrite_MATCH': {'key_width': 9, 'type': 'match'},
 'tunnel_src_rewrite_ACTION': {'num_fields': 8, 'type': 'action'},
 'tunnel_src_rewrite_MATCH': {'key_width': 9, 'type': 'match'},
 'vlan_decap_ACTION': {'num_fields': 8, 'type': 'action'},
