...
action do_something2() {
    modify_field(l3_metadata.nexthop_index, example_metadata.fldB);
}
...
action do_something4() {
    modify_field(ingress_metadata.egress_ifindex, example_metadata.fldC);
}
